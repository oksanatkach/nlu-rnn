...
print("\n### TEST 2: computing loss and mean loss")
...
print("\n### TEST 5: computing binary prediction loss")
...
print("\n### TEST 7: binary prediction BPTT with 3 steps")
r.deltaU.fill(0)
r.deltaV.fill(0)
r.deltaW.fill(0)
...
print("\n### TEST 8: compute accuracy for binary prediction")
